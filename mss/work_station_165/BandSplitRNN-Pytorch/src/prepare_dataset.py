...
from data.open_dataset import OpenDataset
...
def run_program(
    ...
    with open(file_path, 'w') as wf:
        for track in tqdm(db):
            ...
            indices = sad.calculate_salient_indices(y[None, :]) # don't know why shape lack a dim
            # write to file
...
def main(
    ...
    # initialize open dataset parser
    ...
    for target in targets:
        ...
        run_program(file_path, target, od, sad)
