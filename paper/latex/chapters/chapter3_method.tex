...
% 本研究之兩種樂器的切割比例閥值為$r_{violin}=0.0016$, $r_{piano}=0.0054$，
...
% \\
% 上述兩個頻帶陣列代表訓練時所切割的頻帶點，
% 例如Violin的子頻帶為(0-355Hz,\ 355-455Hz,\ $\dots$ ,\ 13042-22050Hz)，
% Piano的子頻帶為(0-100Hz,\ 100-200Hz,\ $\dots$ ,\ 9191-22050Hz)
