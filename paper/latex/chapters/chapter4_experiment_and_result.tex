...
本研究使用的現場演奏樂器為小提琴，電腦輸出音訊為鋼琴，在現場音訊與參考音訊速度的設定上我們跟隨
...
我們可以透過現場MIDI檔案生成正確的鋼琴伴奏音訊，因此不需要額外的節拍追蹤工具輔助。
...
我們也顯示了四種速度的對齊路徑結果圖，橫軸為現場音訊的時間點，縱軸為參考音訊的時間點，
